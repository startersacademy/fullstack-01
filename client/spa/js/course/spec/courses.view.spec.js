...
var View = require('../courses.view.js');
var matchers = require('jasmine-jquery-matchers');
var _ = require('../../vendor/index')._;
var Backbone = require('../../vendor/index').Backbone;

// Test suite
console.log('Test courses.view');
...
describe('Courses view ', function(){
  ...
  describe('when the view is instantiated ', function() {
    ...
    it('sets the correct class', function () {
      view.render();
      expect(view.$el).toHaveClass('courses');
    });
  });
  ...
  describe('when the view is rendered', function(){
    ...
    it('produces the correct HTML', function(){
      view.render();
      expect(view.$('h1').html()).toEqual('Courses');
      expect(view.$('.course')[0]).toHaveText('Full Stack Dev I');
    });
  });
  ...
  describe('when the user clicks on the Sort By Title button ', function(){
    beforeEach(function(){
      view.render();
    });
  ...
  describe('when the user clicks on the Sort By Course Type ', function(){
    beforeEach(function(){
      view.render();
    });

    it('triggers the sortByCourseType event on the collection', function(){
      var spy = jasmine.createSpy('sortByCourseType');
      collection.on('sortByCourseType', spy);
      view.$('.sortByCourseType').trigger('click');
      expect(spy).toHaveBeenCalled();
    });
